...
$$
Cost(\sigma_{pais='Uzbekistan'}) = Height(I(Pais, Clientes)) + \lceil \frac{n(Clientes)}{V(Pais, Clientes) \cdot F(Clientes)} \rceil
$$
$$
Cost(\sigma_{pais='Uzbekistan'}) = 2 + \lceil \frac{1.200.000-250.000-200.000-150.000}{80 \cdot 3} \rceil
$$
$$
...
$$
$$
n(\sigma_{pais='Argentina' \lor pais='Uzbekistan'}) = n(\sigma_{pais='Argentina'}(Clientes)) + n(\sigma_{pais='Uzbekistan'}(Clientes)) 
$$
$$
n(\sigma_{pais='Argentina' \lor pais='Uzbekistan'}) = 200.000 + 7.500 = 207.500
$$
2.
