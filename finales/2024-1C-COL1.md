1. Precios (cod_art, fecha_desde, precio).

Escriba una consulta que devuelva el precio de todos los artículos el 13 de mayo de 2021
(devolviendo el código de artículo y el precio).
...
3. Se sospecha que algunas personas tienen más de un usuario en la red. Para intentar detectarlas se busca encontrar pares de usuario que ambos hayan trabajado en al menos 3 mismas empresas y tengan al menos 5 conocidos en común.
Escriba una consulta en Cypher que devuelva los pares de usuarios que cumplen lo anterior, sin repetir el mismo par.
...
- Clientes (DNI, apellido, nombre, domicilio, telefono)
- Préstamos Vencidos (cod_prestamo, concepto, monto, DNI)
